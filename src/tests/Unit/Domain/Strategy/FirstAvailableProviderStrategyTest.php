...
use App\Domain\Strategy\FirstAvailableProviderStrategy;
...
class FirstAvailableProviderStrategyTest extends TestCase
{
    public function testExecute()
    {
        ...
        $thirdAvailableProvider->expects($this->never())->method('sendNotification');
        ...
        $strategy = new FirstAvailableProviderStrategy($loggerMock, $trackerMock);
